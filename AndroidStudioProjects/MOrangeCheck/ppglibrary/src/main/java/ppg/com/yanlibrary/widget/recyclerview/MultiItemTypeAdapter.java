...
import ppg.com.yanlibrary.widget.recyclerview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(ViewGroup viewGroup, View view, Object o, int position);

        boolean onItemLongClick(ViewGroup viewGroup, View view, Object o, int position);
    }
