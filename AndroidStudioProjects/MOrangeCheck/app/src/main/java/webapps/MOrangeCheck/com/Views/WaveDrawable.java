...
public class WaveDrawable extends Drawable implements Animatable, ValueAnimator.AnimatorUpdateListener {
    ...
    //遮盖层的颜色过滤器
    //注意透明度
    private static PorterDuffColorFilter Porterfilter = new PorterDuffColorFilter(
            Color.parseColor("#befabe46"), PorterDuff.Mode.SRC_ATOP);
    ...
    public void draw(Canvas canvas) {
        ...
        mDrawable.setColorFilter(Porterfilter);
