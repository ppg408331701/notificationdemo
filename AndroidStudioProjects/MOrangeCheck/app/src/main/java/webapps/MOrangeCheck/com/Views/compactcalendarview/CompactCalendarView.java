...
public class CompactCalendarView extends View {
    ...
    public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new CompactCalendarController(new Paint(), new OverScroller(getContext()),
                ...
                Color.argb(255, 100, 68, 65), new webapps.MOrangeCheck.com.Views.compactcalendarview.EventsContainer(Calendar.getInstance()),
                Locale.getDefault(), TimeZone.getDefault());
        gestureDetector = new GestureDetectorCompat(getContext(), gestureListener);
        animationHandler = new webapps.MOrangeCheck.com.Views.compactcalendarview.AnimationHandler(compactCalendarController, this);
    }
