...
/**
 * 时间线//https://github.com/vipulasri/Timeline-View
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, ConvertUtils.dp2px(20));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, ConvertUtils.dp2px(2));
        ...
        if (mStartLine == null && mEndLine == null) {
            mStartLine = new ColorDrawable(ContextCompat.getColor(mContext, android.R.color.darker_gray));
            mEndLine = new ColorDrawable(ContextCompat.getColor(mContext, android.R.color.darker_gray));
        }
    }
