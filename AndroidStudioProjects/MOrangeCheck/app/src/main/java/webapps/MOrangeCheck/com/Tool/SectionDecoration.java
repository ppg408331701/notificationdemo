...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<MonthTimeBean> dataList;
    ...
    public SectionDecoration(List<MonthTimeBean> dataList, Context context, DecorationCallback decorationCallback) {
        Resources res = context.getResources();
        this.dataList = dataList;
        this.callback = decorationCallback;
        //设置悬浮栏的画笔---paint  
        paint = new Paint();
        paint.setColor(res.getColor(R.color.huise1));
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position + 1 < itemCount) {
                ...
                //组内最后一个view进入了header  String型要用equals比较
